...
public class Student {
	...
	public boolean validateAge(int age) {
		if (age >= 18 && age <= 35) {
			...
			System.err.println("Invalid Age!!! Students age needs to be in between 18 and 35!!!");
			return false;
		}
	}
	...
	public boolean validateStudentId(String studentId) {
		...
		if (studentIdMatcher.matches()) {
			...
			System.err.println("Invalid ID!!! Please enter ID in following format S-1234!!!");
			return false;
		}
	}
	...
	public boolean validateCourseName(String course) {
		if (course.equalsIgnoreCase("Java") || course.equalsIgnoreCase("DSA") || course.equalsIgnoreCase("DevOps")) {
			...
			System.out.println("Invalid course name!!! Please select courses from the List!!! [Java, DSA, DevOps]");
			return false;
		}
	}
